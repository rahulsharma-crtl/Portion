...
const RecipeCard: React.FC<RecipeCardProps> = ({ data }) => {
  ...
  const generateShareText = () => {
    return `🍽️ ${data.recipeTitle}
⏱️ Cook Time: ${data.cookTime}
    ...
    <div className="bg-white rounded-2xl shadow-lg border border-stone-200 overflow-hidden mb-8">
      ...
      <div className="bg-stone-100 p-6 border-b border-stone-200">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div className="flex-grow">
            <div className="flex items-start gap-3 justify-between md:justify-start">
              ...
              <div className="flex gap-2 flex-shrink-0">
                <button
                  onClick={handleCopy}
                  className="p-2.5 text-stone-500 bg-white border border-stone-200 hover:text-emerald-600 hover:border-emerald-200 hover:bg-emerald-50 rounded-xl transition-all shadow-sm active:scale-95"
                ...
                <button
                  onClick={handleShare}
                  className="p-2.5 text-stone-500 bg-white border border-stone-200 hover:text-blue-600 hover:border-blue-200 hover:bg-blue-50 rounded-xl transition-all shadow-sm active:scale-95"
                  title="Share Recipe"
                >
            ...
            <div className="flex flex-wrap gap-4 mt-3 text-stone-600 text-sm font-medium">
          ...
          {/* Nutrition Summary */}
          <div className="bg-white p-3 rounded-xl border border-stone-200 shadow-sm flex gap-4 text-center self-start md:self-center w-full md:w-auto justify-between md:justify-start">
             <div>
